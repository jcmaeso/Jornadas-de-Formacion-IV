...
static fsm_trans_t simon_transition_table[] = {
		...
		{START_LEVEL,input_condition_game_win,WAIT_START,output_func_win_secuence},
		{WAIT_USER_SEQUENCE,input_condition_check_timeout,WAIT_START,output_func_timeout},
